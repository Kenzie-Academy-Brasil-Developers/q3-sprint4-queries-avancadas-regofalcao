...
VALUES
    ...
    ('Chrystian', 'chrystian@example.com', '4321', (SELECT id FROM enderecos  WHERE rua LIKE '%Marcelino%' AND cidade = 'Curitiba')),
    ('Matheus', 'matheus@example.com', '3214', (SELECT id FROM enderecos  WHERE rua LIKE '%Higienópolis%' AND cidade = 'Londrina'));
